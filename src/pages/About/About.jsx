        ...
        <div className={styles.about__items}>
          <div className={styles.about__item}>
            <div className={styles.about__itemContent}>
              ...
              <p>
                Morbi porttitor ligula in nunc varius sagittis. Proin
                dui nisi, laoreet ut tempor ac, cursus vitae eros.
                Cras quis ultricies elit. Proin ac lectus arcu.
                Maecenas aliquet vel tellus at accumsan. Donec a eros
                non massa vulputate ornare. Vivamus ornare commodo
          ...
          <div className={styles.about__item}>
            <div className={styles.about__itemContent}>
              ...
              <p>
                Ut suscipit egestas suscipit. Sed posuere pellentesque
                nunc, ultrices consectetur velit dapibus eu. Mauris
                sollicitudin dignissim diam, ac mattis eros accumsan
                rhoncus. Curabitur auctor bibendum nunc eget
                elementum.
              </p>
              <ul>
                <li>
              ...
              <Button>
                Shop Now
                <span className="icon-arr-r"></span>
              </Button>
            </div>
            <div className={styles.about__itemImage}>
              <img
